...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="relative flex items-center justify-between px-4 py-2 bg-slate-900/95 backdrop-blur-md border-b border-slate-800 z-30 shadow-md select-none">
      {/* 1. Left: Audi Emblem, Branding & Train Popover */}
      <div className="flex items-center gap-3">
        {/* Audi 4-Rings Emblem */}
        <div className="flex items-center gap-2 group cursor-pointer" onClick={() => setIsHwInfoOpen(!isHwInfoOpen)}>
          <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-slate-800 to-slate-950 border border-slate-700 flex items-center justify-center shadow-inner group-hover:border-amber-500/50 transition">
          ...
          <div>
            <div className="flex items-center gap-1.5">
              <span className="text-sm font-black tracking-tight text-white group-hover:text-amber-400 transition">
                AUDI MMI STUDIO
              </span>
            ...
            <div className="flex items-center gap-2 text-[10px] text-slate-400 font-mono">
              <span className="hover:text-slate-200">HN+R_EU_AU_K0942_4</span>
      ...
      <div className="flex items-center gap-2">
        <nav className="flex items-center gap-1 bg-slate-950/80 p-1 rounded-xl border border-slate-800/80 shadow-inner">
          {/* Primary Tabs */}
          <button
          ...
          <button
            ...
            className={`px-3.5 py-1.5 text-xs rounded-lg font-medium transition-all flex items-center gap-1.5 ${
              activeTab === 'build'
          ...
          <div className="relative" ref={toolsRef}>
            <button
              ...
              className={`px-2.5 py-1.5 text-xs rounded-lg font-medium transition-all flex items-center gap-1.5 ${
                isSecondaryActive
            ...
            >
              ...
              <span>{isSecondaryActive && activeSecondary ? activeSecondary.label : 'Tools'}</span>
      ...
      <div className="flex items-center gap-2.5">
        ...
        <div
          ...
          className="flex items-center gap-2 px-2.5 py-1.5 rounded-lg border border-slate-800 bg-slate-950/80 hover:border-slate-700 cursor-pointer transition"
          ...
          <div className="absolute top-12 right-24 w-80 bg-slate-950 border border-slate-700 rounded-xl p-4 shadow-2xl z-50 text-xs space-y-2.5 animate-in fade-in zoom-in-95 duration-150">
            ...
            <div className="space-y-2 text-[11px] text-slate-300">
              ...
              <div className="flex items-start gap-2">
                <span className="text-emerald-400 font-bold">✓</span>
                <div>
                  <strong className="text-white">Immutable Originals:</strong> OEM firmware files in <code className="text-amber-400 font-mono">originals/</code> are read-only and crytographically anchored.
                </div>
              </div>
              <div className="flex items-start gap-2">
                <span className="text-emerald-400 font-bold">✓</span>
        ...
        <button
          ...
          className="px-2.5 py-1.5 text-xs font-semibold rounded-lg border border-slate-700/80 bg-slate-800/80 hover:bg-slate-700 text-slate-200 hover:text-white flex items-center gap-1.5 transition shadow-sm hover:border-amber-500/50"
          title="Open MMI Workstation Reset Manager [Hotkey: R]"
        >
          <span className="text-amber-400 font-bold text-sm leading-none">↺</span>
          <span>Reset</span>
          <span className="text-[10px] font-mono text-slate-500 border border-slate-700 px-1 rounded">R</span>
        </button>
      </div>
